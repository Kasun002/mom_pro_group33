    ...
    <body >
        ...
        <div class="container">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="mother_view.php"><span class="glyphicon glyphicon-briefcase"> Appointment</span></a></li>
        ...
        <div class="col-lg-12">
            ...
            <div class="main">
                ...
                <div class="space">
                    ...
                    <div class="space">
                        Start date: <span id="start"></span> <a href="#" onclick="picker.show();
